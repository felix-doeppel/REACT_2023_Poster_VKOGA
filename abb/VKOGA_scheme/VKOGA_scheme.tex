...
\tikzset{ % node styles, numbered for easy mapping with \nstyle
	...
	node 5/.style={node,black,draw=black,fill=black!20},
	node 6/.style={node,mydarkred,draw=white},
}
...
\begin{document}
	...
	\begin{tikzpicture}[x=2.4cm,y=1.2cm]
		...
		\readlist\Cstr{\ln p,,c,$$r$$,\Minus,\scalebox{1.5}{\ensuremath{\dot{s}}}} % array of coefficient symbol per layer
