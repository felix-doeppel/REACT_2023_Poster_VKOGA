...
\tikzset{ % node styles, numbered for easy mapping with \nstyle
	...
	node 3/.style={node,mydarkblue,draw=black},
	node 4/.style={node,black,draw=black},
	node 5/.style={node,black,draw=black},
	node 6/.style={node,mydarkblue,draw=myblue,fill=myblue!20},
}
...
\begin{document}
	...
	\begin{tikzpicture}[x=2.4cm,y=1.2cm]
		\readlist\Nnod{3,3,5,2,1,1} % array of number of nodes per layer
		\readlist\Nstr{n,n+1,m,2,,} % array of string number of nodes per layer
		\readlist\Cstr{\ln p,,,$$r$$,\Minus,\scalebox{1.2}{\ensuremath{\dot{s}}}} % array of coefficient symbol per layer
...
%					\draw[connect] (N\lay-\i) --++ (0.5,0); % arrows out
				...
				% previously, first->second layer was not fully connected
%					\ifnumcomp{\lay}{>}{1}{ % connect to previous layer
%						\foreach \j in {1,...,\Nnod[\prev]}{ % loop over nodes in previous layer
...
%					}
		...
		% LABELS
		\node[above=3,align=center,mygreen,font=\fontfamily{phv}\selectfont] at (N1-1.90) 
		{Input};
...
%		{Minmax\\[-0.2em]Mapped};
		\node[above=2,align=center,black,font=\fontfamily{phv}\selectfont] at (N3-1.90) 
		{$K$};
		\node[above=3,align=center,black,font=\fontfamily{phv}\selectfont] at (N4-1.90) 
		{\contour{white} {\shortstack{Reaction\\ Rates}}};
		\node[above=3,align=center,black,font=\fontfamily{phv}\selectfont] at (N5-1.90) 
		{Substract};
		\node[above=3,align=center,mydarkblue,font=\fontfamily{phv}\selectfont] at (N6-1.90) 
		{Sourceterm};
