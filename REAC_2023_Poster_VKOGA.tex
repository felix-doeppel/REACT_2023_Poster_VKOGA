...
\begin{document}
	\title{Representing detailed surface kinetics by \\ Neural Networks}
	\author{\large \underline{Felix Döppel}\inst{a,*} \and Martin Votsmeier\inst{a,b}}
	\institute{\inst{a}Technische Universität Darmstadt, Alarich-Weiss-Str. 8, 64287 Darmstadt, Germany, \hfill \inst{*}Contact: felix.doeppel@tu-darmstadt.de \\
	\inst{b}Umicore AG \& Co. KG, Rodenbacher Chaussee 4, 63457 Hanau, Germany
	}
