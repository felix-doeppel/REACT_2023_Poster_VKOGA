...
\begin{posterboxenv}{name=Further Information,row=7,rowspan=4,column=5,span=4}
	\begin{multicols}{2}
		...
		\captionof{figure}{Relative prediction error vs. model size.}
		\columnbreak
		\includegraphics[width=.485\textwidth]{abb/VKOGA_hist}
		\captionof{figure}{
			The goal-oriented model automatically requests training data where our previous work\textsuperscript{[2]} showed that the kinetics are harder to model (PEI~=~0.5).
		}
	\end{multicols}	
\end{posterboxenv}
