...
%	\begin{minipage}{0.675\textwidth}
	\begin{itemize}
		\item Extend the novel two-layered Kernel Models\textsuperscript{[3]} with a goal-oriented approach
...
\begin{posterboxenv}[title=3. Results]{name=Results,column=1,row=7,span=4,rowspan=4}
	\begin{itemize}
		\item Goal-oriented models \textbf{sample data only where it's needed}
...
\begin{multicols}{2}		
	\begin{itemize}
		\item Goal-oriented approach enables intelligent data sampling
		\item Two-layered models are more accurate and need less data
